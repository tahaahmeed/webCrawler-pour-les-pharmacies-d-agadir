CREATE DATABASE  IF NOT EXISTS `convertisseur` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `convertisseur`;
-- MySQL dump 10.13  Distrib 5.5.16, for Win32 (x86)
--
-- Host: localhost    Database: convertisseur
-- ------------------------------------------------------
...
-- Dump completed on 2015-02-18 14:56:30
